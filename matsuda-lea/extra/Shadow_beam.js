...
var FSHADER_SOURCE=document.getElementById('frag-shader').textContent;
...
function main() {
  ...
  viewProjMatrixFromLight.setPerspective(30.0, OFFSCREEN_WIDTH/OFFSCREEN_HEIGHT, 1.0, 100.0);
